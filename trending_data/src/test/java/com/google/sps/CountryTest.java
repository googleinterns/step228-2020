...
/** Class to test that parsing of country file is correct. The file
is in TSV format and each country has six corresponding fields.
Also test that a Country object is constructed correctly, i.e. all the
fields take appropriate values. */
@RunWith(JUnit4.class)
public final class CountryTest {
  private static final String EMPTY_STRING = "";
  private static final String INIT = "\tCountry\tCO\tCOU\t0\t0\t0"; /** Use this to construct a Country() object */
  ...
  /** Use this for floating point comparison.
  ...
  public void parseTSVIntoCorrectFields() {
    /** Checks that for a tab-separated string, the correct fields
    are returned */
  ...
  public void constructCountryWithCorrectFields() {
    /** Checks that Country constructor initializes the appropriate
    fields correctly, i.e. name, alpha 2 code, latitude, longitude */
  ...
  public void throwsExceptionWhenEmptyString() {
    /** Checks that an IllegalArgumentException is thrown if the parsing
    of an empty string is attempted */
    String[] parsingResult = parser.parse(EMPTY_STRING);
  }

  @Test
  public void parseTSVIntoCorrectNumberOfFields() {
    /** Checks that for a tab-separated string, the correct number
    of fields are returned */
    String[] parsingResult = parser.parse(ALBANIA);
